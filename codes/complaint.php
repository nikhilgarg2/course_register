...
echo "<tr><td>". $row['name'].'	</td><td>---</td><td>	'.$row['subject'].'	</td><td>---</td><td>	'.$row['email'].'	</td></tr></table><br><p class="font2">Message</p>'.$row['message']." <br><br><hr width=2px color=solidblue>";
